...
export default function ProductPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ========================================
          SECTION 1: HERO - BOLD & CONVERSION FOCUSED
          ======================================== */}
      <section className="relative pt-24 pb-0 overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-white space-y-8">
              ...
              <div className="grid grid-cols-3 gap-6 py-6 border-y border-white/10">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">Max Pressure</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#D6312F] mb-1">
                    35+ yrs
                  </div>
                  <div className="text-sm text-gray-400">OEM Experience</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="#quote-form"
                  className="group relative px-8 py-5 bg-gradient-to-r from-[#D6312F] to-red-600 rounded-xl font-bold text-lg shadow-2xl shadow-[#D6312F]/50 hover:shadow-[#D6312F]/70 transition-all hover:scale-105"
                >
                ...
                <a
                  ...
                  download
                  className="group px-8 py-5 bg-white/5 backdrop-blur-sm border-2 border-white/20 rounded-xl font-bold text-lg hover:bg-white/10 transition-all"
                >
                  <span className="flex items-center justify-center">
            ...
            {/* RIGHT: Hero Product Visual with Glass Card */}
            <div className="relative">
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="absolute -right-4 top-1/4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float">
                ...
                <div
                  className="absolute -left-4 bottom-1/4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100 animate-float"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Card 1 */}
                <div className="group relative bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 hover:border-[#D6312F] hover:shadow-xl transition-all">
                  <div className="w-12 h-12 bg-[#D6312F] rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Documented bolt loads meet client QA/QC standards with full
                    traceability
                  </p>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 hover:border-[#D6312F] hover:shadow-xl transition-all">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Leak-free starts guaranteed with calibration certificates
                    included
                  </p>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 hover:border-[#D6312F] hover:shadow-xl transition-all">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    One tool, multiple bolt sizes via interchangeable sockets.
                    Reduce inventory 40%
                  </p>
                </div>
                ...
                <div className="group relative bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 hover:border-[#D6312F] hover:shadow-xl transition-all">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Rapid dispatch from OEM facility. On-site support & spares
                    worldwide
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              {[
                ...
                <div key={i} className="flex items-center space-x-2">
                  <ChevronRight className="w-4 h-4 text-[#D6312F]" />
            ...
            {[
              {
                ...
                text: "Confined Space Design",
              },
              {
                icon: <Award className="w-5 h-5" />,
                text: "Industrial-Strong",
              },
              {
                icon: <Clock className="w-5 h-5" />,
                text: "Shutdown Optimized",
              },
            ].map((feature, i) => (
              <div
                key={i}
              ...
              >
                <span className="text-[#D6312F]">{feature.icon}</span>
      ...
      {/* ========================================
          SECTION 7: RELATED PRODUCTS - CROSS-SELL
          ======================================== */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Explore our full range of hydraulic solutions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {related.map((p) => (
              <Link
                ...
                className="group"
              >
                <div className="relative bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#D6312F] hover:shadow-2xl transition-all">
                  {/* Image */}
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <div className="text-xs font-bold text-[#D6312F] mb-2">
                      {p.category}
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#D6312F] transition-colors">
                      {p.name}
                    </h3>
                    ...
                    <div className="text-xs text-gray-500 mb-4 space-y-1">
                      <div>Torque: {p.torqueRange}</div>
                      <div>Weight: {p.weight}</div>
                    </div>

                    <div className="flex items-center text-[#D6312F] font-bold text-sm">
                      View Details
      ...
      <section
        id="quote-form"
        className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 overflow-hidden"
      >
        {/* Background Effects */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-[#D6312F]/10 via-transparent to-blue-600/10"></div>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          {/* Contact Form Card */}
          <div className="bg-white rounded-3xl p-10 shadow-2xl border-2 border-gray-800 mb-12">
            <ContactForm />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <a
              href="tel:+1234567890"
              className="flex items-center space-x-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group"
            >
              <div className="w-14 h-14 bg-[#D6312F] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <div className="text-gray-400">+1 (234) 567-8900</div>
              </div>
            </a>

            <a
              href="mailto:sales@tritorc.com"
              className="flex items-center space-x-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all group"
            >
              ...
              <div>
                ...
                <div className="text-gray-400">sales@tritorc.com</div>
              </div>
            </a>
          </div>
...
// ========================================
// CLIENT MARQUEE COMPONENT - MODERN VERSION
// ========================================
