...
export default function CaspianHomePage() {
  ...
  const translations = {
    ...
    cta: {
      ...
      subtitle:
        "Get in touch with our Caspian team for expert consultation and tailored solutions",
    ...
    footer: {
      ...
      legal: "Legal",
      description:
        "Leading provider of precision torque tools across the Caspian region",
    },
  };

  // Set default values for country and lang
  const country = "casp";
  const lang = "en";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-cyan-50">
          ...
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-blue-100/50 rounded-full blur-3xl animate-pulse delay-1000" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-xl">
                Delivering world-class torque solutions across Azerbaijan,
                Kazakhstan, and Turkmenistan for oil & gas, petrochemical, and
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                {[
                  ...
                  { icon: Globe, label: "Countries", value: "3 Nations" },
            ...
            <div className="relative">
              ...
              <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
                <img
                  src="/images/caspian-industrial.jpg"
                  alt="Tritorc Caspian Industrial Solutions"
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-blue-200/30 rounded-2xl -z-10" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Engineered for precision, built for reliability across Caspian
              region oil & gas and industrial applications
            </p>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From oil & gas to power generation, we power critical operations
              across Azerbaijan, Kazakhstan, and Turkmenistan
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Dedicated teams across Azerbaijan, Kazakhstan, and Turkmenistan",
                icon: Globe,
              },
              {
                title: "Fast Delivery",
                desc: "Regional warehouses for quick dispatch and emergency support",
                icon: TrendingUp,
              },
              {
                title: "Quality Assured",
                desc: "ISO certified manufacturing with stringent quality control",
                icon: Award,
              },
              {
                title: "Expert Guidance",
                desc: "Technical support from oil & gas industry veterans",
                icon: Shield,
              },
            ].map((feature, idx) => (
              <div
      ...
      {/* Caspian Countries Coverage */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-blue-700">
        <div className="max-w-7xl mx-auto text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Serving the Caspian Energy Corridor
          </h2>
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Strategic presence across key energy-producing nations with local
            teams ready to support your operations
          </p>
            ...
            {[
              {
                country: "Azerbaijan",
                flag: "🇦🇿",
                desc: "Baku operations serving oil & gas sector",
              },
              {
                country: "Kazakhstan",
                flag: "🇰🇿",
                desc: "Almaty & Aktau regional coverage",
              },
              {
                country: "Turkmenistan",
                flag: "🇹🇲",
                desc: "Supporting energy infrastructure projects",
              },
            ].map((location, idx) => (
              <div
                key={idx}
                className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all"
              >
                <div className="text-6xl mb-4">{location.flag}</div>
                <h3 className="text-2xl font-bold mb-2">{location.country}</h3>
                <p className="text-blue-100">{location.desc}</p>
              </div>
            ))}
          </div>
        </div>
