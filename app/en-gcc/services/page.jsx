...
export const metadata = {
  title: "Industrial Services | Tritorc GCC",
  description:
    "Comprehensive industrial services across the GCC region. Hot tapping, line stopping, torque solutions, and technical support for oil & gas, petrochemical, and power generation industries.",
};
  ...
  const services = [
    {
      ...
      link: "/en-gcc/services/hot-tapping",
      badge: "Most Popular",
    },
    {
      id: "torque-solutions",
    ...
    },
    {
      ...
      description:
        "Flexible rental and leasing options for hydraulic torque equipment. Short-term projects to long-term contracts available.",
      icon: Clock,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
          <div className="text-center max-w-4xl mx-auto text-white space-y-6">
            ...
            <h1 className="text-5xl lg:text-7xl font-black leading-[1.1]">
              ...
              <br />
              <span className="text-[#D6312F]">Critical Operations</span>
            </h1>

            <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed">
              Delivering specialized industrial services across the GCC region
              with unmatched expertise, safety standards, and 24/7 support for
              oil & gas, petrochemical, and power generation sectors.
            </p>

            {/* Key Stats */}
            <div className="grid grid-cols-3 gap-6 pt-8 max-w-3xl mx-auto border-t border-white/20">
              <StatBadge label="Countries" value="6+" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Trusted partner for critical industrial operations across the GCC
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                icon: Clock,
                title: "24/7 Support",
                desc: "Emergency response teams available round the clock across GCC",
              },
              {
                icon: Award,
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Trusted across critical sectors in the GCC region
            </p>
          </div>
